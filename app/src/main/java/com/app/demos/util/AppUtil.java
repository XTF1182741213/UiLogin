...
public class AppUtil {
	...
	static public BaseMessage getMessage (String jsonStr) throws Exception {
		...
		try {
			Log.d("Result数据",jsonStr);

				//jsonStr=jsonStr.replaceAll("\"","\\\\\"" );

			Log.d("替换后",jsonStr);

			//jsonStr="{\"code\":\"10002\",\"message\":\"Login ok\",\"result\":{\"Customer\":{\"id\":1,\"name\":\"james\",\"sign\":\"Happying\",\"face\":\"1\",\"blogcount\":0,\"fanscount\":0,\"uptime\":\"2011-11-29 18:11:24\",\"sid\":\"nbrj7qiau4o65ugkupjfep8ugq2hh1ts\"}}}";
             //jsonStr="{\"code\":\"10002\",\"message\":\"Login ok\",\"result\":{\"Customer\":{\"id\":3,\"name\":\"xiaofei\",\"sign\":\"flyfly\",\"face\":\"xietufei\",\"blogcount\":0,\"fanscount\":0,\"uptime\":\"2018-01-25 15:56:07\",\"sid\":\"go6rcunhvjqac62msl9nd3ppa7a8q6v4\"}}}";
			...
			if (jsonObject != null) {
				...
				Log.d("AppResult",jsonObject.getString("result"));
